...
from .app import mcp
from .client import _fred_get, _fred_v2_get, _geofred_get, _parse_json_object
from .errors import _error_payload, _tool_error_boundary
...
async def get_category_series(
    ...
    data = await _fred_get(
        ...
        {
            "category_id": category_id,
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("category/series", order_by),
...
async def get_category_tags(
    ...
    return await _fred_get(
        "category/tags",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("category/tags", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "tag_names": tag_names,
...
async def get_category_related_tags(
    ...
    return await _fred_get(
        "category/related_tags",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("category/related_tags", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "tag_group_id": tag_group_id,
            "search_text": search_text,
            "realtime_start": realtime_start,
...
async def get_releases(
    ...
    data = await _fred_get(
        "releases",
        {
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("releases", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "realtime_start": realtime_start,
            "realtime_end": realtime_end,
        },
...
async def get_release_dates(
    ...
    return await _fred_get(
        ...
        {
            "release_id": release_id,
            "limit": _normalize_limit(limit, 1, 10000),
            "offset": _normalize_offset(offset),
            "sort_order": _normalize_sort_order(sort_order),
            "include_release_dates_with_no_data": include_release_dates_with_no_data,
            "realtime_start": realtime_start,
...
async def get_release_series(
    ...
    data = await _fred_get(
        "release/series",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("release/series", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "filter_variable": filter_variable,
            "filter_value": filter_value,
            "tag_names": tag_names,
...
async def get_release_tags(
    ...
    return await _fred_get(
        "release/tags",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("release/tags", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "tag_names": tag_names,
            "tag_group_id": tag_group_id,
            "search_text": search_text,
...
async def get_release_related_tags(
    ...
    return await _fred_get(
        "release/related_tags",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("release/related_tags", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "tag_group_id": tag_group_id,
            "search_text": search_text,
            "realtime_start": realtime_start,
...
async def get_series(
    ...
    if not rows:
        return _error_payload(
            ...
            code="not_found",
            error_type="not_found",
            details={"resource": "series", "resource_id": series_id},
        )
    return rows[0]
...
async def get_observations(
    ...
    data = await _fred_get(
        "series/observations",
        {
            ...
            "realtime_start": realtime_start,
            "realtime_end": realtime_end,
            "limit": _normalize_limit(limit, 1, 100000),
            "offset": _normalize_offset(offset),
            "sort_order": _normalize_sort_order(sort_order),
...
async def search_series(
    ...
    data = await _fred_get(
        "series/search",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("series/search", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "filter_variable": filter_variable,
            "filter_value": filter_value,
            "tag_names": tag_names,
...
async def search_series_by_tags(
    ...
    return await _fred_get(
        "series/search/tags",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("series/search/tags", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "tag_group_id": tag_group_id,
            "search_text": search_text,
            "realtime_start": realtime_start,
...
async def search_series_related_tags(
    ...
    return await _fred_get(
        "series/search/related_tags",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("series/search/related_tags", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "tag_group_id": tag_group_id,
            "search_text": search_text,
            "realtime_start": realtime_start,
...
async def get_series_tags(
    ...
    return await _fred_get(
        "series/tags",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("series/tags", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "tag_names": tag_names,
            "tag_group_id": tag_group_id,
            "search_text": search_text,
...
async def get_sources(
    ...
    return await _fred_get(
        "sources",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("sources", order_by),
            "sort_order": _normalize_sort_order(sort_order),
        },
    )
...
async def get_source_releases(
    ...
    return await _fred_get(
        "source/releases",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("source/releases", order_by),
            "sort_order": _normalize_sort_order(sort_order),
        },
    )
...
async def get_tags(
    ...
    return await _fred_get(
        "tags",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("tags", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "tag_names": tag_names,
            "tag_group_id": tag_group_id,
            "search_text": search_text,
...
async def get_related_tags(
    ...
    return await _fred_get(
        "related_tags",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("related_tags", order_by),
            "sort_order": _normalize_sort_order(sort_order),
            "tag_group_id": tag_group_id,
            "search_text": search_text,
        },
...
async def get_tag_series(
    ...
    data = await _fred_get(
        "tags/series",
        {
            ...
            "limit": _normalize_limit(limit, 1, 1000),
            "offset": _normalize_offset(offset),
            "order_by": _normalize_order_by("tags/series", order_by),
            "sort_order": _normalize_sort_order(sort_order),
        },
    )
    series_rows = [_compact_series_row(row) for row in data.get("seriess", [])]
...
async def get_release_observations_v2(
    ...
    return await _fred_v2_get(
        "release/observations",
        {
            ...
            "date": date,
            "series_id": series_id,
            "limit": _normalize_limit(limit, 1, 500000),
            "offset": _normalize_offset(offset),
            "sort_order": _normalize_sort_order(sort_order),
